...
// This class maintains a state (occupancy) and notifies observers when it changes.
public class Room implements ISubject {
    ...
    public void setOccupantCount(int count) {
        ...
        // Occupancy is detected when at least two people enter
        boolean newOccupancyState = (count >= 2);

        // Notify observers only if the state changes to avoid spamming
